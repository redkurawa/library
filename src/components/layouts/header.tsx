    ...
    <div className='sm-container flex h-20 items-center justify-between'>
      ...
      <div>
        <div className='text-md hidden items-center gap-4 md:flex'>
          <Button
            className='cursor-pointer px-8 text-neutral-950 hover:border-0 hover:bg-neutral-200/40 hover:text-black'
            variant={'outline'}
            size={'md'}
          >
          ...
          <Button
            className='cursor-pointer px-8 hover:bg-neutral-200/30 hover:text-white'
            variant={'secondary'}
            size={'md'}
          >
